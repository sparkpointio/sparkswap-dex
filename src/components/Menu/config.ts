...
const config: MenuEntry[] = [
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                href: "https://app.sparkswap.finance/#/stake",
            },
        ],
    },
    // {
    ...
    },
    {
        ...
        items: [
            {
                label: 'Home',
                href: 'https://app.sparkswap.finance/#/nft',
            },
            {
                label: 'Create',
                href: 'https://app.sparkswap.finance/#/nft/create',
            },
            {
                label: 'My NFTs',
                href: 'https://app.sparkswap.finance/#/nft/my-nft',
            },
        ],
    },
    {

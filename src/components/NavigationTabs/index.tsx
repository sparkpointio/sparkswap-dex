...
import { ButtonMenu, ButtonMenuItem, Text } from '@sparkpointio/sparkswap-uikit'
...
export const Nav = ({ activeIndex = 0 }: { activeIndex?: number }) => (
  <ButtonMenu activeIndex={activeIndex} size="sm" variant="subtle">
    ...
    <HistoryLink id="pool-nav-link" to="/liquidity">
...
export function FindPoolTabs() {
  return (
    <Tabs>
      <RowBetween style={{ padding: '1rem', justifyContent: 'flex-start' }}>

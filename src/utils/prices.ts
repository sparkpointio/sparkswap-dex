import { CurrencyAmount, Fraction, JSBI, Percent, TokenAmount, Trade } from '@sparkpointio/sparkswap-sdk'
...
export function formatExecutionPrice(trade?: Trade, inverted?: boolean): string {
  ...
  return inverted
    ? `${trade.executionPrice.invert().toSignificant(6)} ${trade.inputAmount.currency.symbol} per ${
        trade.outputAmount.currency.symbol
      }`
    : `${trade.executionPrice.toSignificant(6)} ${trade.outputAmount.currency.symbol} per ${

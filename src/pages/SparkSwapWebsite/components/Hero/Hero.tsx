    ...
    return (
      <IDOHomeWrapper>
        <StyledFlex>
          ...
          <CustomHeading>
            <StyledSpan>The easiest way <br/> to airdrop your tokens!<br/></StyledSpan>
          </CustomHeading>
          <div>
            <LaroSubHeaderText>
              Send tokens to thousands of addresses in just a couple of seconds! 
              Use your <CustomStyledLink href="https://sparkswap.finance/#/swap?outputCurrency=0xC3440c10c4F36f354eB591B19FafB4906d449B75">SRKb</CustomStyledLink> and <CustomStyledLink href="https://sparkswap.finance/#/swap?outputCurrency=0x37ac4d6140e54304d77437a5c11924f61a2d976f">SFUEL</CustomStyledLink> tokens for discounted rates. <br/>
              <Button as="a" href="https://multisend.sparkswap.finance" style={{ background: 'linear-gradient(to right, #0071BC, #39BEEC)', borderRadius: '6px', margin: '2em 0px' }}>
        ...
        <ImageDiv>
          <IDODynamicImageContainer>
            <Link href="https://multisend.sparkswap.finance">
              {multisenderHero}
            </Link>
          </IDODynamicImageContainer>
        </ImageDiv>

...
const TransactionDeadlineSetting:React.FC<{ onDismiss?: () => void,}> = ({onDismiss}) => {
  ...
  return (
    <StyledTransactionDeadlineSetting>
      <Label>
        <Text style={{ fontWeight: 30  }} fontSize="15px">
          {/* <Flex flexDirection="column" style={{ textAlign: 'right'}}>
      ...
      <Field>
        <DeadlineInput placeholder="Custom" type="number" step="1" min="1" value={value} onChange={handleChange} />

...
import OneColumnModal from 'components/OneColumnModal'
...
const CustomTransactionConfirmationModal = ({
  isOpen,
  onDismiss,
  attemptingTxn,
  hash,
  ...
  return (
    <OneColumnModal isOpen={isOpen} onDismiss={onDismiss} maxHeight={90}>
      {attemptingTxn ||
...
export default CustomTransactionConfirmationModal

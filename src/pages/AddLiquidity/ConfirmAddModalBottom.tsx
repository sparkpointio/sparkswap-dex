...
export function ConfirmAddModalBottom({
  ...
  return (
    <div>
      <RowBetween>
        <Body fontSize="12px" bold>{currencies[Field.CURRENCY_A]?.symbol} Deposited</Body>
        <RowFixed>
          <Body fontSize="14px" style={{textAlign: 'right'}}>{parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)}</Body>
        </RowFixed>
      </RowBetween>
      <RowBetween>
        <Body fontSize="12px" bold>{currencies[Field.CURRENCY_B]?.symbol} Deposited</Body>
        <RowFixed>
      ...
      <RowBetween>
        <Body fontSize="12px" bold>Rates</Body>
